<style type="text/css">.emojionearea .emojionearea-picker .emojionearea-tones {top: 45px;}</style>
<div class="row">
            ...
            <div class="card">
                ...
                <div class="body pb0">
                    <div class="row mb0">
                        ...
                        <div class="col-sm-4">
                            <b><?=l('Instagram account message')?></b>
                            <div class="form-group mb0">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group mb0">
                                ...
                                <select name="follow_type" class="form-control show-tick">
                                    <option value="followers"><?=l('Followers message')?></option>
                                    <option value="following"><?=l('Following message')?></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="body pt0">
                                    <div class="row clearfix">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb0">
                                            <!-- Tab panes -->
                                            <div class="row mt15">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb0" style="padding-right: 0px;padding-left: 0px;">
                                            ...
                                            <div class="row mt15 box-post-schedule" style="display: block;">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb0" style="padding-right: 0px;padding-left: 0px;">
                                                    <div class="custom-card" style="border-radius: 4px;">
                                                        <div class="body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <b><i class="fa fa-clock-o" aria-hidden="true"></i> <?=l('Time post message')?></b>
                                                                ...
                                                                <div class="col-md-6 col-xs-6">
                                                                    <b><i class="fa fa-bullseye" aria-hidden="true"></i> <?=l('Delay (minutes) message')?></b>
                                                                    <div class="input-group mb0">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mb0">
                                                                    <div class="btn-group" role="group">
                                                                        <button type="button" class="btn bg-light-green waves-effect btnSaveSchedules"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> <?=l('Save the schedule')?></button>
                                                                    </div>
                                                                </div>
                                                            </div>

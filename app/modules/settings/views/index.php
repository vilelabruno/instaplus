...
?>
<style type="text/css">.card .body {font-size: 10px;}</style>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active">
                                    ...
                                    <?php if(get('error')){?>
                                    <p>Clique <a href="http://instaplus.com.br/" target="_blank">aqui</a> para comprar uma licensa.</p>
                                    <br/>
                                    <?php }?>
                                </div>
                            </div>
                            <button type="submit" class="btn bg-light-green waves-effect"><?=l('Submit')?></button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-sm-12 mb0">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home_with_icon_title">
                                    ...
                                    <b><?=l('Google map API key')?> (<a href="https://youtu.be/zWoS6CC9rjo" target="_blank">Video guide</a>)</b>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="google_api_key" value="<?=!empty($result)?$result->google_api_key:""?>">
                                        <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">Click here to create new Google API Key</a>
                                    </div>
                                    <b><?=l('Theme color')?></b>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                              <a href="<?=BASE?>lang/en.xml" target="_blank" class="btn bg-blue waves-effect"><i class="fa fa-info-circle"></i> <?=l('View demo')?></a>
                                            </span>
                                        </div>
                                    </div>
                                    <b><?=l('Register user')?></b>

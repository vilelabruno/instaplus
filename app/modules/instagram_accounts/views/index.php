                ...
                <div class="header">
                	<div class="form-inline">
                        <div class="btn-group" role="group">
                            <div class="btn-group" role="group">
                                <button type="button" class="btn bg-blue waves-effect dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <?=l('Action')?>
                    ...
                    <table class="table table-bordered table-striped table-hover js-dataTableSchedule mb0">
                        ...
                        <tbody>
                            ...
                            <tr class="pending" data-action="<?=cn('ajax_action_item')?>" data-action-groups="<?=cn('ajax_get_groups')?>" data-id="<?=$row->id?>">
                                ...
                                <td><a href="https://Instagram.com/<?=$row->username?>" target="_blank"><?=$row->username?></a></td>
                                <td class="text-center"><button type="button" class="btn bg-light-green waves-effect btnUpdateGroups" data-type="page" data-id="<?=$row->id?>" data-action-groups="<?=cn('ajax_get_groups')?>"><?=l('Update Token')?></button></td>
                                <td style="width: 60px;">
                                    <div class="switch">
                                ...
                                <td style="width: 80px;">
                                    <div class="btn-group" role="group">
                                        <a href="<?=cn('update?id='.$row->id)?>" class="btn bg-blue waves-effect"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        <button type="button" class="btn btn-danger waves-effect btnActionModuleItem" data-action="delete" data-confirm="<?=l('Are you sure you want to delete this item?')?>"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <?php }}?>

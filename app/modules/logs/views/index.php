<div class="logs">
    ...
    <div class="box_tab_log_list">
        <ul class="nav nav-tabs tab-nav-right tab_logs_list" role="tablist">
            <li role="presentation" class="<?=get("action")==''?'active':''?>"><a href="<?=url("logs")?>"><?=l('All')?></a></li>
            ...
            <li role="presentation" class="<?=get("action")=='like'?'active':''?>"><a href="<?=url("logs?action=")?>like&account=<?=(int)get("account")?>"><?=l('Like')?></a></li>
            <li role="presentation" class="<?=get("action")=='comment'?'active':''?>"><a href="<?=url("logs?action=")?>comment&account=<?=(int)get("account")?>"><?=l('Comment')?></a></li>
            <li role="presentation" class="<?=get("action")=='follow'?'active':''?>"><a href="<?=url("logs?action=")?>follow&account=<?=(int)get("account")?>"><?=l('Folow')?></a></li>
            <li role="presentation" class="<?=get("action")=='like_follow'?'active':''?>"><a href="<?=url("logs?action=")?>like_follow&account=<?=(int)get("account")?>"><?=l('Like + Follow')?></a></li>
            ...
            <li role="presentation" class="<?=get("action")=='unfollow'?'active':''?>"><a href="<?=url("logs?action=")?>unfollow&account=<?=(int)get("account")?>"><?=l('Unfollow')?></a></li>
